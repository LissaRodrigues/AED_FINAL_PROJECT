...
public class Cirrhosis_Centre_Coordinator_WorkAreaJPanel extends javax.swing.JPanel {
    ...
    Cirrhosis_Centre_Organization cancerCentreOrganization;
    ...
    public Cirrhosis_Centre_Coordinator_WorkAreaJPanel(UserAccount account,Cirrhosis_Centre_Organization cancerCentreOrganization, Enterprise enterprise, EcoSystem system, Network network) {
        initComponents();
        this.system = system;
    ...
    private void btnProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnProfileMouseClicked
        ...
        ManageLiverCentreCoordinatorProfile manageCancerCoordinatorWorkAreaJPanel = new ManageLiverCentreCoordinatorProfile(userAccount,cancerCentreOrganization,enterprise);
