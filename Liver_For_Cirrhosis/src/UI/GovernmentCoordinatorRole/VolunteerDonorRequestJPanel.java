...
public class VolunteerDonorRequestJPanel extends javax.swing.JPanel {
  ...
  //private DonorRequest donorRequest;
    ...
    private void initComponents() {
        ...
        requestTable.setBackground(new java.awt.Color(204, 255, 255));
        ...
        add(hlaTypesTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 440, 180, -1));
        ...
        jLabel23.setText("Diagnosis Type");
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        ...
        try {
            ...
            if(donor.getHla() == null)
                donor.setHla(new PersonDIGType());
            donor.getHla().updateHLAlist(hlaTypesTextField.getText());
        }
        catch(Exception e) {
