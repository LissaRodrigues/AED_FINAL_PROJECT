...
//        System.out.println("Inside the non working panel");
    ...
    private void initComponents() {
        ...
        tblMedTechDonors.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request Number", "Donor UID", "Donor Name", "Diagnosis", "Assigned to", "Status"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false
        ...
        buttonAddMarrow.setText("Add Organ to Bank");
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 560, -1, 20));

        buttonMarrowDonated.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        buttonMarrowDonated.setText("Organ donated by the donor");
        ...
        buttonBoneMarrowDiscard.setText("Discard the donated organ");
    ...
    private void buttonAddMarrowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddMarrowActionPerformed
        ...
        try {
            org.getAllHLAs().add(PersonDIGType.createHLA(String.valueOf(txtHLAList.getText())));
            PersonDIGType h = new PersonDIGType();
            h.updateHLAlist(txtHLAList.getText());
            ((Liver_Bank_Organization)org).getInventory().HLACountAdd(h);
          }
