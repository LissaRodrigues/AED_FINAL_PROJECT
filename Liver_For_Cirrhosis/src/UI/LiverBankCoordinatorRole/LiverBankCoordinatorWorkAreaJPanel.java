...
import UI.LiverBankCoordinatorRole.ManageLiverBankCoordinatorProfile;
...
public class LiverBankCoordinatorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form LiverBankCoordinatorWorkAreaJPanel
     */
    boolean a = true;
    private UserAccount userAccount;
    private Liver_Bank_Organization bmBankOrganization;
    private Enterprise enterprise;
    private EcoSystem system;
    private Network network;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    
    public LiverBankCoordinatorWorkAreaJPanel(UserAccount account, Liver_Bank_Organization bmBankOrganization, Enterprise enterprise, EcoSystem business, Network network) {
        initComponents();
    ...
    private void BtnProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnProfileMouseClicked
        ...
        ManageLiverBankCoordinatorProfile managebmBankProfile = new ManageLiverBankCoordinatorProfile(userAccount,bmBankOrganization,enterprise);
    ...
    private void BtnManageRequestsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnManageRequestsMouseClicked
        // TODO add your handling code here:
        LiverRequestJPanel bmBankRequestJPanel = new LiverRequestJPanel( userAccount,  bmBankOrganization, enterprise, network, system);
