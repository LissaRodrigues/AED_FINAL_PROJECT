 ...
 */
package UI.LiverBankCoordinatorRole;
 ...
 * @author cheril
 */
public class LiverRequestJPanel extends javax.swing.JPanel {

    /**
     * Creates new form LiverRequestJPanel
     */
    private UserAccount userAccount;
    private Liver_Bank_Organization marroworganization;
    private Enterprise enterprise;
    private Network network;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    private EcoSystem system;
    
    public LiverRequestJPanel(UserAccount userAccount, Liver_Bank_Organization bmBankOrganization, Enterprise enterprise, Network network, EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List of Organ Requests");
        ...
        jLabel6.setText("Organ Inventory");
...
//                 jPanel1.setVisible(false);
    ...
    private void populateHlaAvailabilityTable() {
        ...
        dtm.setRowCount(0);
//        marroworganization.getInventory().HLACountAdd(new PersonDIGType().updateHLAlist("HLA_A,HLA_B"),6);
//        marroworganization.getInventory().HLACountAdd(new PersonDIGType().updateHLAlist("HLA_A"),5);
//        marroworganization.getInventory().HLACountAdd(new PersonDIGType().updateHLAlist("HLA_A,HLA_B,HLA_C"),7);
//        dB4OUtil.storeSystem(system);
